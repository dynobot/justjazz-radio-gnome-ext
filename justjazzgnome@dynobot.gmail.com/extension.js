...
var JustJazzPopup = GObject.registerClass(
    {
        GTypeName: 'JustJazzPopup'
    },
...
var JustJazzPanelButton = GObject.registerClass(
    {
        GTypeName: 'JustJazzPanelButton'
    },
    class extends PanelMenu.Button {

    _init(player) {
        
        super._init(0.0, "JustJazz");
        ...
        popup = new JustJazzPopup(player);
...
function enable() {
    ...
    button = new JustJazzPanelButton(player);
